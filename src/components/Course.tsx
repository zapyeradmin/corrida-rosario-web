      ...
      <div className="container-custom">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {[
            ...
            <div key={index} className="bg-white rounded-xl p-6 shadow-md card-hover reveal text-center" data-animation="fade-up">
              <div className="bg-race-primary/10 p-4 inline-block rounded-lg mb-4 mx-auto">
